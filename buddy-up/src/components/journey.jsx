        ...
        <div className='container pb-0'>
          <div className='row p-3 d-lg-flex d-none'>
            <div className='col-lg-6 text-center pt-lg-5'>
              <img src={'/asset/phone1.svg'} className='journey-img' />
            </div>
            <div className='col-lg-6'>
              <div className='row'>
                ...
                <div className='col-8'>
                  ...
                  <br /> <br /> <br />
                  <p className='journey-p secondP'>
                    Find your best matches and connect with your community in
                    the local group chat.
                  </p>
                  <p className='journey-p thirdP'>
                    Meet up for a workout and well-earned coffee
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='row p-3 d-lg-none'>
            <div className='col-12 text-center'>
              <h3 className='font-weight-bold color-495057'>
                Start Your Journey
              </h3>
            </div>
                  ...
                  <div className='carousel-item active'>
                    <div className='row'>
                      ...
                      <div className='col-12 text-center'>
                        ...
                        <p className='journey-p h-25 w-75'>
                          Create your profile, show people who you are don't
                          forget to add workout data.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className='carousel-item'>
                    <div className='row'>
                      ...
                      <div className='col-12 text-center'>
                        ...
                        <p className='journey-p h-25 w-75'>
                          Find your best matches and connect with your community
                          in the local group chat.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className='carousel-item'>
                    <div className='row'>
                      ...
                      <div className='col-12'>
                        ...
                        <p className='journey-p h-25 w-75'>
                          Meet up for a workout and well-earned coffee. <br />
                          &nbsp;
                        </p>
                      </div>
                    </div>
